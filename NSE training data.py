...
dataset = pd.read_csv('C:/Users/om/Downloads/NSE Training Data - 1st Jan 2016 to 1st Jan 2022.csv')
dataset.head(5)
dataset.tail(5)
...
dataset.dropna(subset=['Open','High','Low','Close','Volume'],inplace=True)
dataset.isnull().sum()
